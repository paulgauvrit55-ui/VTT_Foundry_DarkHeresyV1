...
export default class WeaponSheet extends HandlebarsApplicationMixin(ItemSheetV2) {
  ...
  static PARTS = {
    body: { template: "systems/dark-heresy-v1/templates/item/weapon.hbs" }
  };
  ...
  async _prepareContext(options) {
    ...
    context.isMelee = this.item.system.isMelee;
